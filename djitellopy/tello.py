...
class Tello:
    ...
    def get_udp_video_address(self):
        udp_add = 'udp://@' + self.VS_UDP_IP + ':' + str(self.VS_UDP_PORT) # + '?overrun_nonfatal=1&fifo_size=5000'
        return udp_add  
    ...
    def get_frame_read(self):
        ...
        if self.background_frame_read is None:
            self.background_frame_read = BackgroundFrameRead(self, self.get_udp_video_address()).start() # How is this 3 positinal arguments
...
class BackgroundFrameRead:
    ...
    '''   this is two positional arguments, self and address  
    def __init__(self, address):
        self.cap = cv2.VideoCapture(address)
        #self.cap = tello.cap
    '''
    #this is three positional arguments, self, tello and address doesn't tie up with line 169?  
    def __init__(self, tello, address):
        ...
        if not self.cap.isOpened():
            ...
            print ("Video wasn't opened on startup")
        else:
            print ("Video Opened on startup")
